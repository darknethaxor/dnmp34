...
echo -e "\n\033[1;91m[\e[1;97m+\033[1;91m]\033[1;93m Installing Youtube-dl...."
pip install youtube-dl 2> /dev/null > /dev/null
echo -e "\n\033[1;91m[\e[1;97m+\033[1;91m]\033[1;93m Installing requests......"
pip install requests 2> /dev/null > /dev/null
echo -e "\n\033[1;91m[\e[1;97m+\033[1;91m]\033[1;93m Installing wget"
pip install wget 2> /dev/null > /dev/null
cp -r dnmp34 /data/data/com.termux/files/usr/bin
chmod +x /data/data/com.termux/files/usr/bin/dnmp34
mkdir /sdcard/Dnmp34 2> /dev/null > /dev/null
clear
echo -e "\033[1;92mType dnmp34 ANYWHERE"
